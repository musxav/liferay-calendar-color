...
<div class="lfr-search-container <%= resultRows.isEmpty() ? "aui-helper-hidden" : StringPool.BLANK %>">
	...
	<div class="results-grid" id="<%= namespace + id %>SearchContainer">
		...
		%>
            ...
            String colorEvent = "";
            if (row.getParameter("colorEvent") != null) { 
            	colorEvent = (String) row.getParameter("colorEvent");
                rowClassName = rowClassName.replaceAll("results-row",""); %>

			    <tr class="<%= rowClassName %>" <%= AUIUtil.buildData(data) %> style="<%= colorEvent %>">
